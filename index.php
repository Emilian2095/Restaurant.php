    ...
    <nav class="navbar navbar-expand-lg position-fixed">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.php"><span class="colorLink">Home</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="dishes.php"><span class="colorLink">Dishes</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="form.php"><span class="colorLink">Add food</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="reservation.php"><span class="colorLink">Reservation</span></a>
                    </li>
                    <li> <a class="nav-link" href="logout.php?logout"><span class="colorLink">Logout</span></a></li>
                </ul>
            </div>
        </div>
    </nav>
